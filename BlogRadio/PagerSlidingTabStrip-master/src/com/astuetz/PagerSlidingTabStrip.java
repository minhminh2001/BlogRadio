...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColorActive = 0xFF666666;
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (i == currentPosition)
                    tab.setTextColor(tabTextColorActive);
                else
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // height, rectPaint);
        float offset = height - indicatorHeight;
        RectF rect = new RectF(lineLeft + 20, (height - indicatorHeight) + offset/2,
                lineRight - 20, height - offset);
        // canvas.drawOval(rect, rectPaint);
        // canvas.drawArc(rect, 180, 0, true, rectPaint);
    ...
    //
    public void setTextColorActiveResource(int resId) {
        this.tabTextColorActive = getResources().getColor(resId);
        updateTabStyles();
    }
